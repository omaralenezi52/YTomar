# YTomar — نسخة يوتيوب موحّدة كاملة
**المطوّر / الحقوق: Omar Alenezi — تيليجرام: [@o5252i](https://t.me/o5252i)** · الإصدار 2.0.0

نسخة يوتيوب خاصة تجمع **كل مميزات الـ18 تويك** طبق الأصل. تُبنى تلقائياً عبر GitHub Actions من **المصادر الأصلية** (PoomSmart وغيرها، عبر هيكل uYouPlus المجرّب) — يعني كل ميزة تشتغل بالضبط زي الأصل، مع وسم حقوقك.

> **طريقتان في المستودع:**
> - **الجذر (المعتمدة):** بناء دقيق من المصادر الأصلية → حزمة `.deb` فيها كل التويكات. (`.github/workflows/build.yml` + `branding/`)
> - **`handwritten/`:** نسختي اليدوية الأولى (dylib واحد، تغطّي المميزات المضمونة فقط) — مرجعية.
